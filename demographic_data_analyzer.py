...
def calculate_demographic_data(print_data=True):
    ...
    # 4. What percentage with advanced education (Bachelors, Masters, Doctorate) make more than 50K?
    ...
    # 6. What percentage of people who work the minimum number of hours per week have a salary >50K?
